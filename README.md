...
=======
# FECOBI Control de Campeonatos — Preproducción v4.13

Versión correctiva sobre v4.12 enfocada en dos riesgos críticos antes de producción: PDF de llave continua con Dieciseisavos/R32 en una sola hoja Legal sin primera página en blanco, y rediseño operativo de Grupos para separar claramente los modos Intercambio y Sustitución, evitando operaciones simultáneas y consumo excesivo de recursos.
...
>>>>>>> 99d8fb2 (Initial commit - CaromChamps baseline)
